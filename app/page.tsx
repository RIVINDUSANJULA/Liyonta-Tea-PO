  ...
  return (
    <main className="min-h-screen bg-[#FDFBF7] p-4 md:p-6 lg:p-8 font-sans">
      <div className="max-w-[1600px] mx-auto space-y-8">
        ...
        {/* --- Premium Tea Header --- */}
        <header className="relative overflow-hidden flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-gradient-to-br from-emerald-950 via-emerald-900 to-teal-900 p-8 rounded-3xl shadow-2xl shadow-emerald-900/20 border border-emerald-800/50">
          {/* Decorative Background Element */}
          <div className="absolute top-0 right-0 -mt-16 -mr-16 text-emerald-800/30 pointer-events-none">
            {/* Image */}
          </div>

          <div className="relative z-10">
            <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white">
              Purchase <span className="text-emerald-400 font-light italic">Order</span>
            </h1>
            <p className="text-emerald-200/80 text-sm mt-2 font-medium tracking-wide">
              Generate & export premium documentation
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 h-[calc(100vh-240px)] min-h-[800px]">
          ...
          <div className="hidden lg:block lg:col-span-7 h-full bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-stone-200/60 overflow-hidden relative group">
            <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-emerald-600 to-amber-500 z-10"></div>
